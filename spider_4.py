...
def get_html_by_selenium():
    ...
    for i in range(0, 150, 25):
        ...
        driver.get(url=f' https://www.trustradius.com/products/asana/reviews?f={i}')
        time.sleep(10)
        text = driver.page_source
        with open(r'html_data/Asana/TR/' + str((i + 25) / 25) + '.txt', 'w+', encoding='utf-8')as f:
            f.write(text)
        driver.quit()
...
def save_data_2(r):
    ...
    book.save(r'html_data/Asana/asana_tr.xls')
...
if __name__ == "__main__":
    ...
    count = 0
    for i in range(1, 8):
        with open(f'html_data/Asana/TR/{i}.txt', 'r', encoding='utf-8') as f:
            t = f.read()
            parse_2(t)
