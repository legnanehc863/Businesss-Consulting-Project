...
def get_html_by_selenium():
    ...
    for i in range(1, 101):
        ...
        driver.get(url=f'https://www.g2.com/products/asana/reviews?page={i}')
        time.sleep(10)
        text = driver.page_source
        with open(r'html_data/Asana/g2/' + str(i) + '.txt', 'w+', encoding='utf-8')as f:
            f.write(text)
        driver.quit()
...
def save_data_1(r):
    ...
    book.save(r'html_data/Asana/Asana_g2.xls')
...
if __name__ == "__main__":
    ...
    count = 0
    for i in range(1, 101):
        with open(f'html_data/Asana/g2/{i}.txt', 'r', encoding='utf-8') as f:
            t = f.read()
            parse_1(t)
